...
metadata is installed as a new immutable version. It carries forward the explicit read-only Affinity,
Harmonic, and Exa integration parity added for the simplified Deal Manager in `0.6.12`.
