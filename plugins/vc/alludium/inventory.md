...
Version `0.6.3` makes the dedicated Origination Manager the primary interactive operator for connected origination integrations, adds truthful sourcing-line readiness transitions, and strengthens receipt-reading, delegation, and user-facing identifier rules. It builds on the measurable Sourcing Line and durable Origination Candidate model introduced in `0.6.2`.
