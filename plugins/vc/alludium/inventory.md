...
**Version**: 0.5.45
**Status**: Embedded Deal Continuity method v1

Version `0.5.45` adds one versioned Embedded Deal Continuity method and task contract for a
...
These skills are included because current `vc_*` Alludium agent templates or task contracts reference them directly.
...
- `vc.run_embedded_deal_continuity`
- `vc.review_ic_memo`
