...
**Version**: 0.5.47
**Status**: Deal and Pipeline Manager coordination contracts

Version `0.5.47` binds Deal Pipeline to the Pack-owned Deal Manager, promotes the stable
`vc_pipeline_autopilot` template to Pipeline Manager, adds approved task coordination, and exposes
stable Live Deal Status Report questions for reviewed follow-up.
