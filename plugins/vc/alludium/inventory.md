...
- The generated `agents/*.md` files are plugin-native compatibility artifacts for external agentic tools; `alludium/agent-templates/*.yaml` remains the source of truth.
