...
- Deal Pipeline, Origination Pipeline, and Deal Execution project type definitions in `alludium/project-types/`
...
The VC task-definition templates advertise `vc_deal_room`, `vc_origination_pipeline`, and `vc_investment_management` as supported project types. The draft `v0.5.49` surface includes those project type definitions, but they still require paired platform ingest support before they can be used as the runtime source of truth.
...
| Generated tasks           | `tasks/`                              | 93 task prompt Markdown files generated from task-definition YAML                        |
...
| Task definition templates | `alludium/task-definition-templates/` | 93 VC workflow, integration-management, and origination task templates plus catalog metadata |
