...
| Surface                   | Path                                  | Notes                                                                                    |
| ------------------------- | ------------------------------------- | ---------------------------------------------------------------------------------------- |
| Skills                    | `skills/`                             | 70 public workflow, integration-management, origination, and Deal Continuity skills used by the VC pack   |
| Generated agents          | `agents/`                             | 13 agent Markdown compatibility artifacts generated from Alludium runtime YAML          |
| Generated tasks           | `tasks/`                              | 94 task prompt Markdown files generated from task-definition YAML                        |
...
| Task definition templates | `alludium/task-definition-templates/` | 94 VC workflow, integration-management, origination, and Deal Continuity task templates plus catalog metadata |
