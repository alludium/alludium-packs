...
| Surface                   | Path                                  | Notes                                                                                    |
| ------------------------- | ------------------------------------- | ---------------------------------------------------------------------------------------- |
| Skills                    | `skills/`                             | 64 public workflow, integration-management, and origination skills used by the VC pack   |
| Generated agents          | `agents/`                             | 9 agent Markdown compatibility artifacts generated from Alludium runtime YAML           |
| Generated tasks           | `tasks/`                              | 78 task prompt Markdown files generated from task-definition YAML                        |
| Agent templates           | `alludium/agent-templates/`           | 9 Alludium runtime templates using the `vc_*` baseline                                   |
| Task definition templates | `alludium/task-definition-templates/` | 78 VC workflow, integration-management, and origination task templates plus catalog metadata |
