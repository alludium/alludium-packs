...
Version `0.6.13` gives the simplified VC Deal Pipeline Manager the same explicit read-only Affinity,
Harmonic, and Exa integration surface as the existing Deal Manager while preserving user-configured
connection resolution and excluding unrelated connected applications.
