...
fixtures first published in `0.5.49`. Their catalog and package provenance are re-pinned to `v0.6.23`
...
selects exactly one Deal Pipeline type. The `v0.6.23` surface requires paired Platform ingest,
