...
Version `0.6.26` enables provider-neutral connected-application discovery for Deal Manager,
...
fixtures first published in `0.5.49`. Their catalog and package provenance are re-pinned to `v0.6.26`
