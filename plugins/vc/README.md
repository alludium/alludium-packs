...
fixtures first published in `0.5.49`. Their catalog and package provenance are re-pinned to `v0.6.6`
...
The VC task-definition templates advertise the four active project types: `vc_deal_room`, `vc_investment_management`, `vc_sourcing_line`, and `vc_origination_candidate`. The `v0.6.6` surface requires paired platform ingest and projection support before it can be used as the runtime source of truth.
