...
- Deal creation request includes non-empty `createRequest.fieldValues.company name`, `createRequest.fieldValues.fund_id`, and the incoming candidate-to-Deal relationship.
